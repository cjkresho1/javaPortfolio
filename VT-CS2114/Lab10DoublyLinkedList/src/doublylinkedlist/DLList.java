...
public class DLList<E> implements Iterable<E>
{
     ...
     * @version 2016.4.2
     * @param <A> - Type of data to be stored in the iterator
     */
    public class RDLListIterator<A> implements Iterator<E>
    {
        ...
        */
        ...
        public void remove() 
        {
            if (remove)
            {
                DLList.this.remove(lastIndex);
                remove = false;
            }
            else
            {
                throw new IllegalStateException("A call must be made to next() "
                        + "before remove() may be called again");
            }
        }
    }
